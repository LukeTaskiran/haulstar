...
const Header = () => {
  ...
  const navigation = [
    ...
    { name: "Student Deals", href: "/student" },
          ...
          <nav className="hidden md:flex items-center space-x-6">
            {navigation.map((item) => (
              <Link
                ...
                } ${item.href === '/student' ? 'bg-yellow-500/10 px-2 py-1 rounded text-yellow-600 hover:text-yellow-700' : ''}`}
              >
                {item.name}
              </Link>
            ))}
            ...
            <nav className="flex flex-col space-y-4">
              {navigation.map((item) => (
                <Link
                  ...
                  } ${item.href === '/student' ? 'bg-yellow-500/10 px-2 py-1 rounded text-yellow-600' : ''}`}
